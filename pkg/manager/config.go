...
type Config struct {
	...
	// ConsolePluginPF4Image is the image of the Console Plugin that is managed by the operator (Patterfly 4 variant, for backward compatibility)
	ConsolePluginPF4Image string
