...
require (
	...
	github.com/redhat-et/bpfd/bpfd-operator v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/redhat-et/bpfd/clients/gobpfd v0.0.0-20230213120310-6d91cf19f8a3 // indirect
