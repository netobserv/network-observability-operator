...
require (
	...
	github.com/netobserv/flowlogs-pipeline v1.9.1-community.0.20250904132635-6df6a80a03df
...
replace github.com/netobserv/flowlogs-pipeline => github.com/leandroberetta/flowlogs-pipeline v0.0.0-20250910204200-598934e552bf
