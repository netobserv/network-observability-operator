...
const (
	...
	netobservBCImage = "quay.io/bpfman-bytecode/netobserv:latest"
)
...
func prepareBpfApplication(bpfApp *bpfmaniov1alpha1.BpfApplication, fc *flowslatest.FlowCollector) {
	...
	var enableDNSValue, enableRTTValue, enableFLowFilterValue, enableNetworkEvents, traceValue, networkEventsGroupIDValue []byte
