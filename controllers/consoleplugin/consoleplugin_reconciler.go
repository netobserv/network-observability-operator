...
func (r *CPReconciler) reconcilePlugin(ctx context.Context, builder builder, desired *flowsv1alpha1.FlowCollectorSpec) error {
...
func (r *CPReconciler) reconcileConfigMap(ctx context.Context, builder builder, desired *flowsv1alpha1.FlowCollectorSpec) (string, error) {
...
func (r *CPReconciler) reconcileService(ctx context.Context, builder builder, desired *flowsv1alpha1.FlowCollectorSpec) error {
...
func (r *CPReconciler) reconcileHPA(ctx context.Context, builder builder, desired *flowsv1alpha1.FlowCollectorSpec) error {
