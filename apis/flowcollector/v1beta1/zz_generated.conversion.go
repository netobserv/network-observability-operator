...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*FLPFilterAnyOf)(nil), (*v1beta2.FLPFilterAnyOf)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_FLPFilterAnyOf_To_v1beta2_FLPFilterAnyOf(a.(*FLPFilterAnyOf), b.(*v1beta2.FLPFilterAnyOf), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta2.FLPFilterAnyOf)(nil), (*FLPFilterAnyOf)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_FLPFilterAnyOf_To_v1beta1_FLPFilterAnyOf(a.(*v1beta2.FLPFilterAnyOf), b.(*FLPFilterAnyOf), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*FLPFilters)(nil), (*v1beta2.FLPFilters)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_FLPFilters_To_v1beta2_FLPFilters(a.(*FLPFilters), b.(*v1beta2.FLPFilters), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta2.FLPFilters)(nil), (*FLPFilters)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_FLPFilters_To_v1beta1_FLPFilters(a.(*v1beta2.FLPFilters), b.(*FLPFilters), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_FLPFilterAnyOf_To_v1beta2_FLPFilterAnyOf(in *FLPFilterAnyOf, out *v1beta2.FLPFilterAnyOf, s conversion.Scope) error {
	out.AllOf = *(*[]v1beta2.FLPSingleFilter)(unsafe.Pointer(&in.AllOf))
	out.Sampling = in.Sampling
	return nil
}

// Convert_v1beta1_FLPFilterAnyOf_To_v1beta2_FLPFilterAnyOf is an autogenerated conversion function.
func Convert_v1beta1_FLPFilterAnyOf_To_v1beta2_FLPFilterAnyOf(in *FLPFilterAnyOf, out *v1beta2.FLPFilterAnyOf, s conversion.Scope) error {
	return autoConvert_v1beta1_FLPFilterAnyOf_To_v1beta2_FLPFilterAnyOf(in, out, s)
}

func autoConvert_v1beta2_FLPFilterAnyOf_To_v1beta1_FLPFilterAnyOf(in *v1beta2.FLPFilterAnyOf, out *FLPFilterAnyOf, s conversion.Scope) error {
	out.AllOf = *(*[]FLPSingleFilter)(unsafe.Pointer(&in.AllOf))
	out.Sampling = in.Sampling
	return nil
}

// Convert_v1beta2_FLPFilterAnyOf_To_v1beta1_FLPFilterAnyOf is an autogenerated conversion function.
func Convert_v1beta2_FLPFilterAnyOf_To_v1beta1_FLPFilterAnyOf(in *v1beta2.FLPFilterAnyOf, out *FLPFilterAnyOf, s conversion.Scope) error {
	return autoConvert_v1beta2_FLPFilterAnyOf_To_v1beta1_FLPFilterAnyOf(in, out, s)
}

func autoConvert_v1beta1_FLPFilters_To_v1beta2_FLPFilters(in *FLPFilters, out *v1beta2.FLPFilters, s conversion.Scope) error {
	out.AnyOf = *(*[]v1beta2.FLPFilterAnyOf)(unsafe.Pointer(&in.AnyOf))
	out.OutputTarget = v1beta2.FLPFilterTarget(in.OutputTarget)
	return nil
}

// Convert_v1beta1_FLPFilters_To_v1beta2_FLPFilters is an autogenerated conversion function.
func Convert_v1beta1_FLPFilters_To_v1beta2_FLPFilters(in *FLPFilters, out *v1beta2.FLPFilters, s conversion.Scope) error {
	return autoConvert_v1beta1_FLPFilters_To_v1beta2_FLPFilters(in, out, s)
}

func autoConvert_v1beta2_FLPFilters_To_v1beta1_FLPFilters(in *v1beta2.FLPFilters, out *FLPFilters, s conversion.Scope) error {
	out.AnyOf = *(*[]FLPFilterAnyOf)(unsafe.Pointer(&in.AnyOf))
	out.OutputTarget = FLPFilterTarget(in.OutputTarget)
	return nil
}

// Convert_v1beta2_FLPFilters_To_v1beta1_FLPFilters is an autogenerated conversion function.
func Convert_v1beta2_FLPFilters_To_v1beta1_FLPFilters(in *v1beta2.FLPFilters, out *FLPFilters, s conversion.Scope) error {
	return autoConvert_v1beta2_FLPFilters_To_v1beta1_FLPFilters(in, out, s)
}
...
func autoConvert_v1beta1_FlowCollectorFLP_To_v1beta2_FlowCollectorFLP(in *FlowCollectorFLP, out *v1beta2.FlowCollectorFLP, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_FLPFilters_To_v1beta2_FLPFilters(&in.Filters, &out.Filters, s); err != nil {
		return err
	}
	// WARNING: in.Debug requires manual conversion: does not exist in peer-type
	return nil
...
func autoConvert_v1beta2_FlowCollectorFLP_To_v1beta1_FlowCollectorFLP(in *v1beta2.FlowCollectorFLP, out *FlowCollectorFLP, s conversion.Scope) error {
	...
	if err := Convert_v1beta2_FLPFilters_To_v1beta1_FLPFilters(&in.Filters, &out.Filters, s); err != nil {
		return err
	}
	// WARNING: in.Advanced requires manual conversion: does not exist in peer-type
	return nil
