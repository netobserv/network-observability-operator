...
type FLPMetrics struct {
	...
	// Note that the more metrics you add, the bigger is the impact on Prometheus workload resources.<br>
	// Available names are: (names followed by `*` are enabled by default)<br>
	// - `namespace_egress_bytes_total`<br>
	// - `namespace_egress_packets_total`<br>
	// - `namespace_ingress_bytes_total`<br>
	// - `namespace_ingress_packets_total`<br>
	// - `namespace_flows_total` *<br>
	// - `node_egress_bytes_total`<br>
	// - `node_egress_packets_total`<br>
	// - `node_ingress_bytes_total` *<br>
	// - `node_ingress_packets_total`<br>
	// - `node_flows_total`<br>
	// - `workload_egress_bytes_total`<br>
	// - `workload_egress_packets_total`<br>
	// - `workload_ingress_bytes_total` *<br>
	// - `workload_ingress_packets_total`<br>
	// - `workload_flows_total`<br>
	// When the `PacketDrop` feature is enabled in `spec.agent.ebpf.features` (with privileged mode), additional metrics are available:<br>
	// - `namespace_drop_bytes_total`<br>
	// - `namespace_drop_packets_total` *<br>
	// - `node_drop_bytes_total`<br>
	// - `node_drop_packets_total`<br>
	// - `workload_drop_bytes_total`<br>
	// - `workload_drop_packets_total`<br>
	// When the `FlowRTT` feature is enabled in `spec.agent.ebpf.features`, additional metrics are available:<br>
	// - `namespace_rtt_seconds` *<br>
	// - `node_rtt_seconds`<br>
