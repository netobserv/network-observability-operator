...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ConfigOrSecret)(nil), (*v1beta2.ConfigOrSecret)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ConfigOrSecret_To_v1beta2_ConfigOrSecret(a.(*ConfigOrSecret), b.(*v1beta2.ConfigOrSecret), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta2.ConfigOrSecret)(nil), (*ConfigOrSecret)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_ConfigOrSecret_To_v1beta1_ConfigOrSecret(a.(*v1beta2.ConfigOrSecret), b.(*ConfigOrSecret), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_ConfigOrSecret_To_v1beta2_ConfigOrSecret(in *ConfigOrSecret, out *v1beta2.ConfigOrSecret, s conversion.Scope) error {
	out.Type = v1beta2.MountableType(in.Type)
	out.Name = in.Name
	out.Namespace = in.Namespace
	return nil
...
// Convert_v1beta1_ConfigOrSecret_To_v1beta2_ConfigOrSecret is an autogenerated conversion function.
func Convert_v1beta1_ConfigOrSecret_To_v1beta2_ConfigOrSecret(in *ConfigOrSecret, out *v1beta2.ConfigOrSecret, s conversion.Scope) error {
	return autoConvert_v1beta1_ConfigOrSecret_To_v1beta2_ConfigOrSecret(in, out, s)
}

func autoConvert_v1beta2_ConfigOrSecret_To_v1beta1_ConfigOrSecret(in *v1beta2.ConfigOrSecret, out *ConfigOrSecret, s conversion.Scope) error {
	out.Type = MountableType(in.Type)
	out.Name = in.Name
	out.Namespace = in.Namespace
	return nil
...
// Convert_v1beta2_ConfigOrSecret_To_v1beta1_ConfigOrSecret is an autogenerated conversion function.
func Convert_v1beta2_ConfigOrSecret_To_v1beta1_ConfigOrSecret(in *v1beta2.ConfigOrSecret, out *ConfigOrSecret, s conversion.Scope) error {
	return autoConvert_v1beta2_ConfigOrSecret_To_v1beta1_ConfigOrSecret(in, out, s)
}
...
// Convert_v1beta1_FLPMetrics_To_v1beta2_FLPMetrics is an autogenerated conversion function.
func Convert_v1beta1_FLPMetrics_To_v1beta2_FLPMetrics(in *FLPMetrics, out *v1beta2.FLPMetrics, s conversion.Scope) error {
	return autoConvert_v1beta1_FLPMetrics_To_v1beta2_FLPMetrics(in, out, s)
}
...
// Convert_v1beta1_FlowCollector_To_v1beta2_FlowCollector is an autogenerated conversion function.
func Convert_v1beta1_FlowCollector_To_v1beta2_FlowCollector(in *FlowCollector, out *v1beta2.FlowCollector, s conversion.Scope) error {
	return autoConvert_v1beta1_FlowCollector_To_v1beta2_FlowCollector(in, out, s)
}
...
// Convert_v1beta2_FlowCollector_To_v1beta1_FlowCollector is an autogenerated conversion function.
func Convert_v1beta2_FlowCollector_To_v1beta1_FlowCollector(in *v1beta2.FlowCollector, out *FlowCollector, s conversion.Scope) error {
	return autoConvert_v1beta2_FlowCollector_To_v1beta1_FlowCollector(in, out, s)
}
...
func autoConvert_v1beta1_FlowCollectorEBPF_To_v1beta2_FlowCollectorEBPF(in *FlowCollectorEBPF, out *v1beta2.FlowCollectorEBPF, s conversion.Scope) error {
	...
	out.EnablePktDrop = (*bool)(unsafe.Pointer(in.EnablePktDrop))
	out.EnableDNSTracking = (*bool)(unsafe.Pointer(in.EnableDNSTracking))
	return nil
}

// Convert_v1beta1_FlowCollectorEBPF_To_v1beta2_FlowCollectorEBPF is an autogenerated conversion function.
func Convert_v1beta1_FlowCollectorEBPF_To_v1beta2_FlowCollectorEBPF(in *FlowCollectorEBPF, out *v1beta2.FlowCollectorEBPF, s conversion.Scope) error {
...
// Convert_v1beta2_FlowCollectorEBPF_To_v1beta1_FlowCollectorEBPF is an autogenerated conversion function.
func Convert_v1beta2_FlowCollectorEBPF_To_v1beta1_FlowCollectorEBPF(in *v1beta2.FlowCollectorEBPF, out *FlowCollectorEBPF, s conversion.Scope) error {
...
func autoConvert_v1beta1_SASLConfig_To_v1beta2_SASLConfig(in *SASLConfig, out *v1beta2.SASLConfig, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_ConfigOrSecret_To_v1beta2_ConfigOrSecret(&in.Reference, &out.Reference, s); err != nil {
		return err
	}
...
func autoConvert_v1beta2_SASLConfig_To_v1beta1_SASLConfig(in *v1beta2.SASLConfig, out *SASLConfig, s conversion.Scope) error {
	...
	if err := Convert_v1beta2_ConfigOrSecret_To_v1beta1_ConfigOrSecret(&in.Reference, &out.Reference, s); err != nil {
		return err
	}
	out.ClientIDKey = in.ClientIDKey
	out.ClientSecretKey = in.ClientSecretKey
