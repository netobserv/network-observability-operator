...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LokiGRPCConfig) DeepCopyInto(out *LokiGRPCConfig) {
	*out = *in
	if in.KeepAlive != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LokiGRPCConfig.
func (in *LokiGRPCConfig) DeepCopy() *LokiGRPCConfig {
	if in == nil {
		return nil
	}
	out := new(LokiGRPCConfig)
