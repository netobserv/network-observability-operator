...
func (in *FlowCollectorLoki) DeepCopyInto(out *FlowCollectorLoki) {
	*out = *in
	...
	if in.Distributed != nil {
		...
		*out = new(LokiDistributedParams)
		**out = **in
	}
	if in.Monolith != nil {
		in, out := &in.Monolith, &out.Monolith
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LokiDistributedParams) DeepCopyInto(out *LokiDistributedParams) {
	*out = *in
	out.TLS = in.TLS
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LokiDistributedParams.
func (in *LokiDistributedParams) DeepCopy() *LokiDistributedParams {
	if in == nil {
		return nil
	}
	out := new(LokiDistributedParams)
