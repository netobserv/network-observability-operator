...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PluginDebugConfig) DeepCopyInto(out *PluginDebugConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PluginDebugConfig.
func (in *PluginDebugConfig) DeepCopy() *PluginDebugConfig {
	if in == nil {
		return nil
	}
	out := new(PluginDebugConfig)
	in.DeepCopyInto(out)
	return out
}
