...
func (in *FlowCollectorKafka) DeepCopyInto(out *FlowCollectorKafka) {
	*out = *in
	if in.AutoInstallSpec != nil {
		in, out := &in.AutoInstallSpec, &out.AutoInstallSpec
...
func (in *FlowCollectorSpec) DeepCopyInto(out *FlowCollectorSpec) {
	*out = *in
	...
	if in.OperatorsAutoInstall != nil {
		in, out := &in.OperatorsAutoInstall, &out.OperatorsAutoInstall
		*out = new([]string)
		if **in != nil {
			in, out := *in, *out
			*out = make([]string, len(*in))
...
func (in *KafkaInstanceSpec) DeepCopyInto(out *KafkaInstanceSpec) {
	*out = *in
	...
	in.ZooKeeperStorage.DeepCopyInto(&out.ZooKeeperStorage)
