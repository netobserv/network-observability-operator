...
To filter two ports, use a "port1,port2" in string format. For example, `ports: "80,100"`.<br/>
        ...
        <td><b><a href="#flowcollectorspecagentebpfflowfilterflowfilterrulesindex">flowFilterRules</a></b></td>
        <td>[]object</td>
        <td>
...
### FlowCollector.spec.agent.ebpf.flowFilter.flowFilterRules[index]
...
To filter two ports, use a "port1,port2" in string format. For example, `ports: "80,100"`.<br/>
        ...
        <td><b><a href="#flowcollectorspecagentebpfflowfilterflowfilterrulesindex-1">flowFilterRules</a></b></td>
        <td>[]object</td>
        <td>
          `flowFilterRules` defines a list of ebpf agent flow filtering rules<br/>
        </td>
