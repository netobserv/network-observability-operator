...
mkdir -p $index_path/new && mv netobserv-operator-1.11.5.tgz $index_path/new && cd $index_path
...
git add netobserv-operator-1.11.5.tgz index.yaml
git commit -m "Publish helm 1.11.5-community"
git push upstream HEAD:main
```
