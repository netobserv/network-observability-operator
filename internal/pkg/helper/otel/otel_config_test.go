...
func TestOtelTransformConfig(t *testing.T) {
	...
	assert.Equal(t, []api.GenericTransformRule{
		...
		{Input: "TLSCipherSuite", Output: "tls.ciphersuite", Multiplier: 0},
		{Input: "TLSGroup", Output: "tls.group", Multiplier: 0},
		{Input: "TLSTypes", Output: "tls.types", Multiplier: 0},
		{Input: "TLSVersion", Output: "tls.version", Multiplier: 0},
