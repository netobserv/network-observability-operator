...
func UseLokiDev(spec *flowslatest.FlowCollectorSpec) bool {
	return UseLoki(spec) && spec.Loki.Mode == flowslatest.LokiModeMonolithic && *spec.Loki.Monolithic.ZeroClick
}
